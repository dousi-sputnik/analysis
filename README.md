...
# 課題
  ...
  現在の状態だけでもABC分析としては機能しますが、表にある商品がどこにあるかは担当者の経験頼りの現状です。
  そこで　「棚割り登録」機能を JANコードをキーとして紐付けすることができれば、商品が「どこの棚のどの列の何番目にあるかが」はっきりわかります。
  今後はそのような追加で便利な機能を実装することが課題です。
